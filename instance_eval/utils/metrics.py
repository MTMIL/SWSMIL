...
from sklearn.metrics import accuracy_score, f1_score, roc_curve, auc, confusion_matrix, recall_score, precision_score

def calculate_full_metrics(logits: torch.Tensor, targets: torch.Tensor, num_classes, confusion_mat=False):
    ...
    return acc, f1, roc_auc, precision, recall
